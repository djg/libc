...
s! {
    ...
    pub struct sockcred {
 	...
 	pub sc_ngroups: ::c_int,
        pub sc_groups: [::git_t,0], // variable length
    }

    // 7.0 compat sockcred
    pub struct sockcred70 {
        pub sc_uid: ::uid_t,
        pub sc_euid: ::uid_t,
        pub sc_gid: ::gid_t,
        pub sc_egid: ::gid_t,
        pub sc_ngroups: ::c_int,
        pub sc_groups: [::gid_t,0], // variable length
    }
}
...
pub const SO_OSNDTIMEO: ::c_int = 0x1005;
pub const SO_ORCVTIMEO: ::c_int = 0x1006;
pub const SO_OTIMESTAMP: ::c_int = 0x0400;
...
pub const SCM_OTIMESTAMP: ::c_int = 0x02;
pub const SCM_OCREDS: ::c_int = 0x04;
...
extern "C" {
    ...
    pub fn pthread_setname_np(t: ::pthread_t, name: *const ::c_char, arg: *mut ::c_void)
        -> ::c_int;
